...
## YOUR CONFIGURATION
annotation_dir = '/home/tusimple/Documents/data/cityperson/annotations'
...
def load_annotation():
    ...
    anno_data = si.loadmat(os.path.join(annotation_dir, file_name))
    return anno_data

def mat2coco(anno_data):
...
if __name__ == '__main__':
    t1 = time.time()
    parse_args()
    print("Converting [%s] dataset into COCO format..."%data_type)
    anno_data = load_annotation()
    res_dict = mat2coco(anno_data)
